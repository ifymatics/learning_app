...
function userTable(table) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      yield sql`CREATE TABLE IF NOT EXISTS ${sql(
        table
      )} (id SERIAL PRIMARY KEY, email TEXT NOT NULL UNIQUE, password TEXT NOT NULL,role TEXT NOT NULL, first_name TEXT NULL, last_name TEXT NULL)`;
    } catch (error) {
...
function topicTable(table) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      ...
      yield sql`CREATE TABLE IF NOT EXISTS ${sql(
        table
      )} (id SERIAL PRIMARY KEY, title TEXT NOT NULL, video TEXT NOT NULL, description TEXT NOT NULL, subjectId INTEGER NOT NULL references subjects(id))`;
    } catch (error) {
      console.log(`creating ${table} failed`);
      console.log(error.message);
    }
...
function rankTable(table) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      yield sql`CREATE TABLE IF NOT EXISTS ${sql(
        table
      )} (id SERIAL PRIMARY KEY, completed BOOLEAN NOT NULL, rate INTEGER NOT NULL, topicscompleted INTEGER [], topicsCount INTEGER NOT NULL , userId INTEGER NOT NULL references users(id), subjectId INTEGER NOT NULL references subjects(id))`;
    } catch (error) {
      console.log(`creating ${table} failed`);
      console.log(error);
    }
...
function durationTable(table) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      yield sql`CREATE TABLE IF NOT EXISTS ${sql(
        table
      )} (id SERIAL PRIMARY KEY, completed BOOLEAN NOT NULL, rate TEXT NOT NULL, subjectId INTEGER NOT NULL references subjects(id), topicId INTEGER NOT NULL references topics(id), userId INTEGER NOT NULL references users(id))`;
    } catch (error) {
      console.log(`creating ${table} failed`);
      console.log(error);
    }
